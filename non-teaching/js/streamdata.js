...
async function loadStreams() {
    showLoading(true);
    try {
        const response = await fetch(`${API_BASE_URL}/api/students/management/streams`);
        const data = await response.json();
...
async function saveStream(event) {
    ...
    showLoading(true);
    try {
        const url = editingStreamId ? `${API_BASE_URL}/api/students/management/streams/${editingStreamId}` : `${API_BASE_URL}/api/students/management/streams`;
...
async function deleteStream(id) {
    ...
    showLoading(true);
    try {
        const response = await fetch(`${API_BASE_URL}/api/students/management/streams/${id}`, { method: 'DELETE' });
        const result = await response.json();
...
async function loadSubjects() {
    showLoading(true);
    try {
        const response = await fetch(`${API_BASE_URL}/api/students/management/subjects`);
        const data = await response.json();
...
async function saveSubject(event) {
    ...
    showLoading(true);
    try {
        const url = editingSubjectId ? `${API_BASE_URL}/api/students/management/subjects/${editingSubjectId}` : `${API_BASE_URL}/api/students/management/subjects`;
...
async function deleteSubject(id) {
    ...
    showLoading(true);
    try {
        const response = await fetch(`${API_BASE_URL}/api/students/management/subjects/${id}`, { method: 'DELETE' });
        const result = await response.json();
